...
def run():
    ...
    for i in range(0,int(window_size[1]*percentage//2.0)):
        renderer.draw_line((0, (window_size[1]/2)-i-2, window_size[0], (window_size[1]/2)-i-2), (0x000000FF))
        renderer.draw_line((0, (window_size[1]/2)-i-1, window_size[0], (window_size[1]/2)-i-1), (0x000000FF))
        renderer.draw_line((0, (window_size[1]/2)-i, window_size[0], (window_size[1]/2)-i), (0x000000AF))
        renderer.draw_line((0, (window_size[1]/2)+i, window_size[0], (window_size[1]/2)+i), (0x000000AF))
        renderer.draw_line((0, (window_size[1]/2)+i+1, window_size[0], (window_size[1]/2)+i+1), (0x000000FF))
        renderer.draw_line((0, (window_size[1]/2)+i+2, window_size[0], (window_size[1]/2)+i+2), (0x000000FF))
        renderer.present()
